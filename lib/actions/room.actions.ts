...
export const getDocument = async ({
  ...
  try {
    ...
    console.log(`Error occured while connecting to the room: ${error}`);
  }
};
...
export const getDocuments = async (email: string) => {
  try {
    ...
    console.log(`Error occured while connecting documents: ${error}`);
  }
};
...
export const updateDocumentAccess = async ({
  ...
  try {
    ...
    console.log("Error occured while sharing access: ", error);
  }
};
...
export const removeCollaborator = async ({
  ...
  try {
    ...
    console.log("Error occured while removing the user access: ", error);
  }
};
